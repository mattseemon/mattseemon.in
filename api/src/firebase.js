/*
Original Copyright Joshua Bence <joshua.bence@gmail.com> and contributors.

The following code is a copy of the code from the firestore-parser project, 
which is licensed under MIT. This code therefore is also licensed under the 
terms of the MIT.

Source: https://github.com/jdbence/firestore-parser

Copyright 2017-2019 Matt Seemon <contact@mattseemon.in>
*/

function getFireStoreProp(value) {
...
export function FireStoreParser(value) {
